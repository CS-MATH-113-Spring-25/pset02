...
\begin{questions}
    ...
    \begin{parts}
        ...
        \part All natural numbers that are either even or odd but not both is a natural number is even and greater than equal to 3 then then if its prime then its not divisible by 2.
        \begin{solution}
            % Enter solution here
        \end{solution}
    \end{parts}
